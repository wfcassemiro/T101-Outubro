    ...
    <section class="glass-hero fade-item" id="home">
        <div class="hero-logo">
            <div class="translators-logo">
                <img src="/images/Logo Webp.svg" alt="Translators 101" class="main-logo" width="280" height="100" fetchpriority="high">
            </div>
        </div>
            ...
            <div class="testimonials-grid-narrow">
                <div class="testimonial-video fade-item">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/7Rp3-rb4fcs" loading="lazy" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>

                <div class="testimonial-video fade-item">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/dlf6fIX4nAc" loading="lazy" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>

                <div class="testimonial-video fade-item">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/LuOWNKPEN3A" loading="lazy" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>

                <div class="testimonial-video fade-item">
                    <div class="video-wrapper">
                        <iframe src="https://www.youtube.com/embed/IZAL_0j7ep8" loading="lazy" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
