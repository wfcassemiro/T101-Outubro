...
<div class="main-content">
    ...
    <div class="video-card profile-card">
        ...
        <div class="list-row">
            ...
            <span class="col-actions">
                <a href="view_certificate_files.php?id=<?php echo htmlspecialchars($cert['id']); ?>" class="cta-btn btn-small">Visualizar</a>
                <a href="download_certificate_files.php?id=<?php echo htmlspecialchars($cert['id']); ?>" class="cta-btn btn-small">Baixar</a>
            </span>
        </div>
        <?php endforeach; ?>
    ...
    <div class="video-card profile-card">
        <div class="card-header"><h2><i class="fas fa-file-alt"></i> Meus relatórios</h2></div>
